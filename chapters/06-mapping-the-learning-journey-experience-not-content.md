...
![Figure 6.2 — The outline shows a topic, the journey shows a wall: the same week three is unremarkable as an outline entry and catastrophic in lived time, where the tool migration, first group assignment, and first feedback-free graded assessment stack](../images/06-mapping-the-learning-journey-experience-not-content-fig-02.png)
...
![Figure 6.1 — Anatomy of a learner journey map: a calendar spine with five parallel lanes, an evidence-status fill on every cell, and the vertical pile-up column that is the diagnostic](../images/06-mapping-the-learning-journey-experience-not-content-fig-01.png)
...
![Figure 6.3 — Where budgets cross: working memory, motivational reserve, and cost tolerance depleting simultaneously at week three, with the attrition step below — a schematic of the stacking mechanism, not measured data](../images/06-mapping-the-learning-journey-experience-not-content-fig-03.png)
...
![Figure 6.4 — The line of visibility: a backstage TA training handoff crosses the dashed line and surfaces frontstage as what looks like learner disengagement](../images/06-mapping-the-learning-journey-experience-not-content-fig-04.png)
