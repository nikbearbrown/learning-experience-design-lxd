...
![Figure 7.2 — The participation spectrum: focus-group theater, requirements-gathering, and co-design, distinguished by whether the design decision is still open when learners enter the room](../images/07-co-design-learners-as-design-partners-fig-02.png)
...
![Figure 7.3 — The fluency–learning inversion: the fluent condition feels better in session, the effortful condition wins on delayed measures (directions documented; magnitudes conceptual)](../images/07-co-design-learners-as-design-partners-fig-03.png)
...
![Figure 7.1 — The three-layer decision-rights split: learner authority is presumptive on the experience layer, evidence authority on the mechanism layer, and the constraints layer is disclosed, not negotiated — one request distributes across all three](../images/07-co-design-learners-as-design-partners-fig-01.png)
