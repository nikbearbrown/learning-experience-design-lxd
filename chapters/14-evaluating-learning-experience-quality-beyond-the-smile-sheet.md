...
![Figure 14.5 — The Forward case in two charts: an NPS of 71 in beloved-brand territory beside a 90-day performance difference statistically indistinguishable from zero — two real numbers, only one of them about learning (whisker schematic)](../images/14-evaluating-learning-experience-quality-beyond-the-smile-sheet-fig-05.png)
...
![Figure 14.3 — The ROI measurement gap: 71% of higher-education technology leaders rate measuring ROI on academic technology as important; only 46% actually measure it (EDUCAUSE 2025)](../images/14-evaluating-learning-experience-quality-beyond-the-smile-sheet-fig-03.png)
...
![Figure 14.4 — Order of operations as integrity instrument: a confound table drafted before unblinding keeps its full-height rows; the same table drafted after a known "win" shrinks — so the second order is refused](../images/14-evaluating-learning-experience-quality-beyond-the-smile-sheet-fig-04.png)
...
![Figure 14.2 — One finding, two registers: the technical register is written first, the stakeholder register is a compression of it, and every stakeholder claim traces back to a technical line](../images/14-evaluating-learning-experience-quality-beyond-the-smile-sheet-fig-02.png)
