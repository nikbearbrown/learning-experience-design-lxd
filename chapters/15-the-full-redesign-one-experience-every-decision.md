...
![Figure 15.1 — The same artifacts, two genres: the gallery arranges them chronologically and asks the reviewer to find the argument; the argument threads them with decision traces and shows it](../images/15-the-full-redesign-one-experience-every-decision-fig-01.png)
...
![Figure 15.2 — The decision trace, the portfolio's unit: what we believed, what evidence bore on it, what we decided, what is still open — with the artifact attached as evidence for one step and the trace's end left live](../images/15-the-full-redesign-one-experience-every-decision-fig-02.png)
...
![Figure 15.3 — Portfolio anatomy: brief, a decision spine that must contain one "no," artifacts captioned by the decisions they served, the open ledger with scheduled tests, the Evidence Disclosure, and two conclusion registers](../images/15-the-full-redesign-one-experience-every-decision-fig-03.png)
...
![Figure 15.4 — Anatomy of a defensible "no": steelman at full strength, specific countervailing evidence, the criterion that decided, and the door left open with a scheduled test — a "no" argued against a strawman is decoration, not discipline](../images/15-the-full-redesign-one-experience-every-decision-fig-04.png)
...
![Figure 15.5 — The overclaim invitation: accepting the causal frame hands the reviewer the thread that unravels every subsequent claim; passing with a precise qualifier — effect observed, attribution withheld, replication scheduled — keeps the claims intact](../images/15-the-full-redesign-one-experience-every-decision-fig-05.png)
...
![Figure 15.6 — The book's arc: from the trap diagnosed, through design, instrumentation, evaluation, and defense — and the bridge running backward to the five-star app you can now diagnose in a paragraph](../images/15-the-full-redesign-one-experience-every-decision-fig-06.png)
