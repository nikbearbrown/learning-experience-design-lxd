# Research Notes: Chapter 03 — The Cognitive Machinery: Load, Difficulty, and Durable Learning

**Source:** `TikTOC.md` chapter entry
**Notes file:** `03-the-cognitive-machinery-load-difficulty-and-durable-learning_notes.md`
**Corresponding chapter:** `chapters/03-the-cognitive-machinery-load-difficulty-and-durable-learning.md` (not yet written)
...
Students learn cognitive architecture as design-actionable mechanisms: load, difficulty, retrieval, spacing, interleaving, and embodied foundations.
...
### Intrinsic, extraneous, and germane load direct design attention
Cognitive load theory diagnoses where working memory is spent. Intrinsic load is inherent task complexity; extraneous load is waste from poor presentation; germane processing is effort directed toward schema construction.

**Common misconception:** The method is a checklist item rather than a decision tool.

**Worked example:** Use the studio project. Ask what design decision changes if this concept is true. Then create a before/after artifact and a one-sentence Evidence Disclosure. For this chapter, the simplest case is: A smoother lesson removes retrieval and reduces retention.

**Source(s):** See priority sources below.

### Desirable difficulty is conditional, not a slogan
A desirable difficulty makes learning feel harder now because it induces processing that improves later retrieval or transfer. The same surface friction can be desirable or harmful depending on prior knowledge, task complexity, timing, and feedback.

**Common misconception:** All difficulty is good, or all friction is bad.

**Worked example:** Use the studio project. Ask what design decision changes if this concept is true. Then create a before/after artifact and a one-sentence Evidence Disclosure. For this chapter, the simplest case is: A smoother lesson removes retrieval and reduces retention.

**Source(s):** See priority sources below.

### Worked examples, retrieval, spacing, and interleaving are sequencing tools
Worked examples, signaling, segmentation, retrieval, spacing, and interleaving are sequencing tools. Use examples early, fade support, then add retrieval and interleaving when learners have enough schema to benefit.
...
### Case 1: A smoother lesson removes retrieval and reduces retention
...
### Case 2: High-element-interactivity material where generation becomes undesirable
Use this as a chapter vignette. State the design situation, the evidence tension, what the designer initially wants to do, and what an evidence-disciplined designer would do instead. Tie the case to the chapter assessment so it is not merely illustrative.

### Failure case: Interface clutter masquerades as rigor
Use this as a chapter vignette. State the design situation, the evidence tension, what the designer initially wants to do, and what an evidence-disciplined designer would do instead. Tie the case to the chapter assessment so it is not merely illustrative.
...
**Prerequisites:** Chapter 02 supplies the immediate prerequisite vocabulary or artifact.

**Unlocks:** Chapter 04 uses this chapter as a design constraint.
...
- Cognitive Load Theory overview: https://advancesinsimulation.biomedcentral.com/articles/10.1186/s41077-018-0086-1
- Undesirable Difficulty Effects in high-element interactivity materials: https://pmc.ncbi.nlm.nih.gov/articles/PMC6099118/
- Spacing and interleaving systematic review: https://link.springer.com/article/10.1007/s10648-021-09613-w
- Embodied learning meta-analysis: https://www.sciencedirect.com/science/article/pii/S1041608024001572
- VR science and education games meta-analysis: https://pubmed.ncbi.nlm.nih.gov/38259582/
- VR/AR anatomy education meta-analysis: https://pubmed.ncbi.nlm.nih.gov/39300601/
- Immersive procedural training in VR review/meta-analysis: https://www.sciencedirect.com/science/article/pii/S0360131524001386
